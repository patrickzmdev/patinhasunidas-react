...
import "./styles.css";
import pzmlogo from "../../assets/logopzm.png";
    ...
    <footer class="px-0 py-0 custom-bg-color ">
      <div class="container flex flex-wrap items-center justify-center mx-auto space-y-4 sm:justify-between sm:space-y-0">
        <div class="flex flex-row pr-3 space-x-4 sm:space-x-8">
          <div class="flex items-center justify-center flex-shrink-0 w-24 h-24 rounded-full mt-2">
            <svg
          ...
          <ul class="flex flex-wrap text-white items-center space-x-4 sm:space-x-8">
            <li rel="noopener noreferrer" _msttexthash="155558" _msthash="474">
        ...
        <div class="space-y-3">
          ...
          <div class="flex justify-start space-x-3">
            <a
              ...
              href="https://x.com/patinhasunidass/"
              target="_blank"
              title="Twitter"
      ...
      <a href="https://pzmsolucoes.com.br/">
        <div className="w-full bg-color-footer h-8 flex justify-center items-center space-x-1 px-2">
          <span className="text-white">© 2025 PZM Soluções Digitais</span>
        </div>
      </a>
    </footer>
  );
