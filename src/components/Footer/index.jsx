  ...
  return(
    <footer class="px-0 py-0 custom-bg-color ">
			<div class="container flex flex-wrap items-center justify-center mx-auto space-y-4 sm:justify-between sm:space-y-0">
				...
				<ul class="flex flex-wrap text-white items-center space-x-4 sm:space-x-8">
					<li rel="noopener noreferrer" _msttexthash="155558" _msthash="474">Entre em contato conosco</li>

				</ul>
				</div>

    <div class="space-y-3">
				<div class="uppercase text-white" _msttexthash="174629" _msthash="492">Redes Sociais</div>
				<div class="flex justify-start space-x-3">

					<a rel="noopener noreferrer" href="https://x.com/patinhasunidass/" target="_blank"  title="Twitter" class="flex items-center p-1">
						<svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 fill-current text-white">
					...
					<a rel="noopener noreferrer" href="https://www.instagram.com/institutopatinhasunidassc/" target="_blank" title="Instagram" class="flex items-center p-1">
						<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" fill="currentColor" class="w-5 h-5 fill-current text-white">
