    ...
    <>
      <div className="p-1 mx-auto sm:p-10 bg-custom-color2 md:p-16">
        <div className="flex flex-col items-center justify-center  max-w-xs mx-auto bg-custom-color1 space-y-4 p-4 ">
            <button type="button" className="w-full px-8 py-3 font-semibold bg-custom-color2 rounded-full text-white" onClick={handleButtonClick}>Clique aqui se você deseja nos ajudar</button>

            {isVisible && (
            <div className="flex flex-col items-center justify-center  max-w-xs h-auto mx-auto space-y-4 p-4">
              <li
                rel="noopener noreferrer"
                className="inline-block text-2xl font-semibold text-white sm:text-3xl m-8"
              >
                Pix-QRCODE
              </li>

                <img src={qrcode} alt="qrcode" className="object-cover object-center max-w-full rounded-md h-auto" />
              ...
              >
                ...
                <button id="copyButton" className="w-full px-8 py-3 font-semibold bg-custom-color rounded-full text-white" onClick={handleCopy}>Copiar Linha Digitavel</button>
            </div>
            )}
        </div>
      </div>
          ...
          <div className="p-8 pb-1 m-8 mx-auto bg-white  mt-10 space-y-6 lg:max-w-2xl sm:px-10 sm:mx-12 lg:rounded-md">
            <div className="space-y-2 ">
              <li
                ...
                className="inline-block text-2xl font-playwrite sm:text-3xl m-4"
              >
            ...
            <div className="container-texto overflow-y-auto object-cover max-h-full md:max-h-full">
              ...
              <a href="https://www.instagram.com/institutopatinhasunidassc/" target="_blank" title="Instagram" class="flex items-center p-4 m-2 justify-center bg-custom-color rounded-md " rel="noreferrer">
						    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" fill="currentColor" class="w-5 text-white h-5 m-1 fill-current">
						  ...
						  </svg><li className="text-white font-semibold ">Acessar Instagram</li>
					    </a>
